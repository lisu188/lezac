...
entry bytes. The synthetic fixture proves parser mechanics, address math, and
malformed-segment rejection. The original fixture captures a temp-copy
`dosbox-debug` stop at `01ED:7C89` with runtime `CS=01ED` and `DS=0C8F`; it
