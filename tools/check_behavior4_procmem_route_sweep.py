...
def main() -> int:
    ...
    for snippet in [
        ...
        "capture_command_behavior4_motion_start_before_bomb_x2p00=",
    ...
    for snippet in [
        ...
        "expected_level=3 targets=2",
        "target_names=behavior4_motion_start,behavior4_motion_end",
        "timings=before_route routes=1",
        "route_labels=x2p00",
        "capture_commands=2",
        "route_preset=branch-x2",
        "capture_command_behavior4_motion_start_before_route_x2p00=",
        "capture_command_behavior4_motion_end_before_route_x2p00=",
    ...
    for snippet in [
        "targets=6",
        "target_names=spawner_loop_start,spawner_loop_end,behavior4_motion_start,behavior4_motion_end,integration_8_8_start,integration_8_8_end",
        "timings=before_bomb routes=1",
        "capture_commands=6",
        "capture_command_behavior4_motion_end_before_bomb_x2p00=",
