#!/usr/bin/env python3
"""Summarize actor dispatch ready-manifest oracle result manifests."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Summarize actor dispatch ready-manifest oracle results."
    )
    ...
    try:
        ...
        print(f"actor_dispatch_ready_result_summary=error reason={exc}", file=sys.stderr)
        return 1
